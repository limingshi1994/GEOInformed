...
def get_args():
    ...
    parser.add_argument("-o", "--out-dir", default='../dummy/', required=False, type=str)
    ...
    parser.add_argument(
        "-b",
        "--bands",
        default=["B04", "B03", "B02", "B08", "SCL", "B01", "B05", "B06", "B07", "B8A", "B11", "B12", "B13"],
        nargs="+",
        type=str,
    )
    parser.add_argument(
...
def main():
    ...
    print(eoconn.describe_collection("TERRASCOPE_S2_TOC_V2"))
